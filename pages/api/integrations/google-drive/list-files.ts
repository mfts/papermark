...
import { GOOGLE_DRIVE_ERRORS, GoogleDriveClient } from "@/lib/google-drive";
...
export default async function handler(
    ...
    try {
        ...
        const { folderIds, folderPathName, teamId, dataroomId } = req.body as {
            folderIds: string[];
...
function buildFolderTree(
    ...
    const folderMap = new Map<string, ProcessedFile>();

...
import useWebhooks from "@/lib/swr/use-webhook";
import WebhooksCard from "@/components/webhooks/webhook-card";
        ...
        <ul role="list" className="space-y-4">
          {webhooks
            ? webhooks.map((webhook) => {
                return <WebhooksCard key={webhook.id} webhook={webhook} />;
              })

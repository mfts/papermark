...
export default function Login() {
  ...
  return (
    <div className="font-display2 flex h-screen w-screen justify-center">
      <div
      ...
      <div className="z-10 mt-[calc(30vh)] h-fit w-full mx-5 sm:mx-0 max-w-md overflow-hidden border border-border bg-gray-50 dark:bg-gray-900 rounded-lg sm:shadow-xl">
        ...
        <div className="flex flex-col px-4 gap-2 py-8 sm:px-16">
          <Button
            onClick={() => {
              signIn("google", {
          ...
          <Button
            ...
            className="flex justify-center items-center"
          >
            <GitHubIcon className="h-6 w-7 mr-2"/>
            {/* <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 488 512"
              fill="currentColor"

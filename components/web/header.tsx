  ...
  return (
    <div className="relative bg-white">
      <div className="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
        <div className="px-6 pb-24 pt-6 sm:pb-32 lg:col-span-7 lg:px-0 lg:pb-56 lg:pt-12 xl:col-span-6">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <h1 className="mt-10 text-3xl lg:text-4xl xl:text-5xl font-bold tracking-tight text-gray-900">
        ...
        <div className="relative md:col-span-5 lg:-mr-8 xl:absolute xl:inset-0 xl:left-1/2 xl:mr-0 mt-6">
          <img
            className="aspect-[16/9] w-full object-contain lg:absolute lg:inset-0 lg:aspect-auto lg:h-full lg:w-full mb-6"

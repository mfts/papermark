...
```bash
npx tsx .agents/scripts/create-justification.ts "decision-name" "Justification content here"
```

Or use heredoc for multi-line content:

```bash
npx tsx .agents/scripts/create-justification.ts "decision-name" << HEREDOC
Multi-line
